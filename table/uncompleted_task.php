<div class='table-list'>
	<center><h5>Not Completed Task</h5></center>
	<table class='table table-hover table-bordered'>
		<thead>
			...
			<tbody>
				<?php
				$query = mysqli_query($connect, "SELECT * FROM list WHERE status = 0");
				...
				while($data = mysqli_fetch_array($query)) {
					...
					echo "
					<a href='proses/proses_checklist.php?id=$id' class='btn small-btn'>
